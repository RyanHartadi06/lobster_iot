...
<head>
  ...
  <title>Sistem Monitoring Kolam Lobster</title>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content bg-white border-0">
              ...
              <div class="modal-footer border-0 gap-3" style="padding: 2rem; padding-top: 0.75rem">
                <a class="btn btn-fill text-white" href="<?= base_url('Login') ?>">Log In</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div class="left-column d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center">
            <h1 class="header-title">
              Sistem Monitoring<br class="desktop"> Kualitas Air Kolam Lobster </h1>
            <p class="subtitle my-5">
              Sistem Monitoring Kualitas Air Kolam Lobster <br class="desktop"> berbasis alat IoT</p>
            <p>
              <br />
            <div class="d-flex flex-sm-row flex-column align-items-center mx-lg-0 mx-auto justify-content-center gap-3">
              <a class="btn d-inline-flex mb-md-0 btn-try text-white" href="<?= base_url('login') ?>">
                Try it free
              </a>
              <a class="btn btn-outline" href="https://www.youtube.com/watch?v=sW0Pul3-mSY" target="__blank">
  ...
  <div class="content-3-1 container-xxl mx-auto position-relative" style="font-family: 'Poppins', sans-serif">
    <div class="d-flex flex-lg-row flex-column align-items-center">
      ...
      <div class="right-column d-flex flex-column align-items-lg-start align-items-center text-lg-start text-center col-lg-6 col-md-6">
        <h2 class="title-text">Solusi Monitoring Kualitas Air Kolam Lobster</h2>
        <ul class="p-0 m-0">
          <li class="list-unstyled" style="margin-bottom: 2rem">
            ...
            <p class="text-caption">
              Kami menggunakan teknologi terbaik dan berbasis hardware
            </p>
          </li>
          <li class="list-unstyled" style="margin-bottom: 2rem">
            <h4 class="title-caption d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
              ...
              Gratis dan akses selamanya
            </h4>
            <p class="text-caption">
              Akses Website Sistem Pendukung Keputusan pemilihan jenis ikan gratis dan dapat diakses selamanya.
            </p>
          </li>
          <li class="list-unstyled" style="margin-bottom: 4rem">
            ...
            <p class="text-caption">
              Real time support dari tim kami siap membantu Anda
            </p>
          </li>
        </ul>
      </div>
    ...
    <div class="content-2-2 container-xxl mx-auto p-0  position-relative" style="font-family: 'Poppins', sans-serif">
      <div class="text-center title-text">
        ...
        <p class="text-caption" style="margin-left: 3rem; margin-right: 3rem">
          Anda dapat dengan mudah memantau kualitas air kolam lobster dan memberikan hasil yang akurat
        </p>
      </div>
        ...
        <div class="row">
          <div class="col-lg-4 column">
            ...
            <p class="icon-caption">
              Sistem akan bekerja sendiri<br />
          ...
          <div class="col-lg-4 column">
            ...
            <p class="icon-caption">
              Dengan realtime analytic dapat <br />
              memudahkan pengguna dalam memantau kualitas air
            </p>
          </div>
          <div class="col-lg-4 column">
            <div class="icon">
            ...
            <h3 class="icon-title">Hasil yang akurat</h3>
            <p class="icon-caption">
              Dapat memberikan hasil yang</br>
              akurat kualitas air dan penentuan jenis ikan
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="d-flex flex-lg-row flex-column align-items-center">
        ...
        <div class="flex-grow-1 text-lg-start text-center card-text">
          ...
          <p class="card-caption">
            Ingin memesan alat pendeteksi kualitas air kolam lobster?
          </p>
          <br>
